    ...
    string ShortName = "")
{
    ...
    /// <inheritdoc/>
    public override string ToString() => (ExecutablePath == string.Empty ? "dotnet" : Path.GetFileNameWithoutExtension(ExecutablePath)).GetShortName("Adds or updates a package reference in a project file.", ShortName, "add", Project.ToArg(), "package", PackageName.ToArg());
}
    ...
    string ShortName = "")
{
    ...
    /// <inheritdoc/>
    public override string ToString() => (ExecutablePath == string.Empty ? "dotnet" : Path.GetFileNameWithoutExtension(ExecutablePath)).GetShortName("Removes package reference from a project file.", ShortName, "remove", Project.ToArg(), "package", PackageName.ToArg());
}
    ...
    string ShortName = "")
{
    ...
    /// <inheritdoc/>
    public override string ToString() => (ExecutablePath == string.Empty ? "dotnet" : Path.GetFileNameWithoutExtension(ExecutablePath)).GetShortName("Lists project-to-project references.", ShortName, "list", Project.ToArg());
}
    ...
    string ShortName = "")
{
    ...
    /// <inheritdoc/>
    public override string ToString() => (ExecutablePath == string.Empty ? "dotnet" : Path.GetFileNameWithoutExtension(ExecutablePath)).GetShortName("Lists local NuGet resources.", ShortName, "nuget", "locals", CacheLocation.ToArg());
}
    ...
    string ShortName = "")
{
    ...
    /// <inheritdoc/>
    public override string ToString() => (ExecutablePath == string.Empty ? "dotnet" : Path.GetFileNameWithoutExtension(ExecutablePath)).GetShortName("Add a NuGet source.", ShortName, "nuget", "add", "source", PackageSourcePath.ToArg());
}
    ...
    string ShortName = "")
{
    ...
    /// <inheritdoc/>
    public override string ToString() => (ExecutablePath == string.Empty ? "dotnet" : Path.GetFileNameWithoutExtension(ExecutablePath)).GetShortName("Lists nuget configuration files currently being appplied to a directory.", ShortName, "nuget", "config", "paths");
}
    ...
    string ShortName = "")
{
    ...
    /// <inheritdoc/>
    public override string ToString() => (ExecutablePath == string.Empty ? "dotnet" : Path.GetFileNameWithoutExtension(ExecutablePath)).GetShortName("Searches for a NuGet package.", ShortName, "package", "search", "paths", SearchTerms.ToArg());
}
    ...
    string ShortName = "")
{
    ...
    /// <inheritdoc/>
    public override string ToString() => (ExecutablePath == string.Empty ? "dotnet" : Path.GetFileNameWithoutExtension(ExecutablePath)).GetShortName("Provides information about the available workload commands and installed workloads.", ShortName, "tool", "workload");
}
    ...
    string ShortName = "")
{
    ...
    /// <inheritdoc/>
    public override string ToString() => (ExecutablePath == string.Empty ? "dotnet" : Path.GetFileNameWithoutExtension(ExecutablePath)).GetShortName("Enables or disables workload-set update mode.", ShortName, "tool", "workload", "config");
}
    ...
    string ShortName = "")
{
    ...
    public IStartInfo GetStartInfo(IHost host)
    {
        ...
        return host.CreateCommandLine(ExecutablePath)
            ...
            .AddArgs("workload")
            .AddArgs("install")
            .AddNotEmptyArgs(Workloads.ToArray().ToArg())
            .AddArgs(Sources.ToArgs("--source", ""))
            .AddArgs(ConfigFile.ToArgs("--configfile", ""))
    ...
    /// <inheritdoc/>
    public override string ToString() => (ExecutablePath == string.Empty ? "dotnet" : Path.GetFileNameWithoutExtension(ExecutablePath)).GetShortName("Installs optional workloads.", ShortName, new [] {"tool", "workload", "install"}.Concat(Workloads).ToArray());
}
    ...
    string ShortName = "")
{
    ...
    /// <inheritdoc/>
    public override string ToString() => (ExecutablePath == string.Empty ? "dotnet" : Path.GetFileNameWithoutExtension(ExecutablePath)).GetShortName("Lists installed workloads.", ShortName, "tool", "workload", "list");
}
    ...
    string ShortName = "")
{
    ...
    /// <inheritdoc/>
    public override string ToString() => (ExecutablePath == string.Empty ? "dotnet" : Path.GetFileNameWithoutExtension(ExecutablePath)).GetShortName("Repairs workloads installations.", ShortName, "tool", "workload", "repair");
}
    ...
    string ShortName = "")
{
    ...
    /// <inheritdoc/>
    public override string ToString() => (ExecutablePath == string.Empty ? "dotnet" : Path.GetFileNameWithoutExtension(ExecutablePath)).GetShortName("Installs workloads needed for a project or a solution.", ShortName, "tool", "workload", "restore", Project.ToArg());
}
...
/// <param name="ExecutablePath">Overrides the tool executable path.</param>
/// <param name="WorkingDirectory">Specifies the working directory for the tool to be started.</param>
/// <param name="SearchStrings">The workload ID to search for, or part of it. For example, if you specify <c>maui</c>, the command lists all of the workload IDs that have <c>maui</c> in their workload ID.</param>
/// <param name="Verbosity">Sets the verbosity level of the command. Allowed values are <see cref="DotNetVerbosity.Quiet"/>, <see cref="DotNetVerbosity.Minimal"/>, <see cref="DotNetVerbosity.Normal"/>, <see cref="DotNetVerbosity.Detailed"/>, and <see cref="DotNetVerbosity.Diagnostic"/>. The default is <see cref="DotNetVerbosity.Minimal"/>. For more information, see <see cref="DotNetVerbosity"/>.</param>
/// <param name="Diagnostics">Enables diagnostic output.</param>
/// <param name="ShortName">Specifies a short name for this operation.</param>
[Target]
    ...
    string ShortName = "")
{
    ...
    /// <inheritdoc/>
    public override string ToString() => (ExecutablePath == string.Empty ? "dotnet" : Path.GetFileNameWithoutExtension(ExecutablePath)).GetShortName("Searches for optional workloads.", ShortName, "tool", "workload", "search");
}
    ...
    string ShortName = "")
{
    ...
    /// <inheritdoc/>
    public override string ToString() => (ExecutablePath == string.Empty ? "dotnet" : Path.GetFileNameWithoutExtension(ExecutablePath)).GetShortName("Uninstalls a specified workload.", ShortName, new [] {"tool", "workload", "uninstall"}.Concat(Workloads).ToArray());
}
    ...
    string ShortName = "")
{
    ...
    /// <inheritdoc/>
    public override string ToString() => (ExecutablePath == string.Empty ? "dotnet" : Path.GetFileNameWithoutExtension(ExecutablePath)).GetShortName("Updates installed workloads.", ShortName, "tool", "workload", "update");
}
